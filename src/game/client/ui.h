...
public:
	...
	void SetGraphics(class IGraphics *pGraphics, class IInput* pInput, class ITextRender *pTextRender) { m_pGraphics = pGraphics; m_pInput = pInput; m_pTextRender = pTextRender;}
