...
CParticles::CParticles()
{
	...
	// mmotee
	m_RenderDamageMmo.m_pParts = this;
	m_RenderMmoEffects.m_pParts = this;
	m_RenderTeleports.m_pParts = this;
	m_RenderMmoProj.m_pParts = this;
}
